# EXAMPLE TO DEMONSTRATE USE OF PRIORITYRESOURCE TO HANDLE SCENARIOS
# WHERE WE WANT OUR QUEUE TO ACT AS A PRIORITY QUEUE INSTEAD OF THE
...
class ED_Patient:
    ...
    # like e.g 20% of the patients that came in have the highest priority
